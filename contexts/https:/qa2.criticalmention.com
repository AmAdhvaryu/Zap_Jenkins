...
<configuration>
    <context>
        <name>POST:session()(password,userAgent,username)</name>
        <desc/>
        <inscope>true</inscope>
        <incregexes>https://qa2.criticalmention.com/*</incregexes>
        <tech>
            <include>Db</include>
        ...
        <authentication>
            <type>4</type>
            <strategy>EACH_REQ_RESP</strategy>
            <pollurl/>
            <polldata/>
            <pollheaders/>
            ...
            <script>
                <name>CmAuth</name>
                <params>RW5kcG9pbnRGb3JBdXRoZW50aWNhdGlvbg==:aHR0cHM6Ly9xYTIuY3JpdGljYWxtZW50aW9uLmNvbS9hbGxtZWRpYS9zZXNzaW9u</params>
            </script>
        </authentication>
        <users>
            <user>831;true;VGVzdGVy;4;cGFzc3dvcmQ=:d2VsY29tZTEyMw==&amp;dXNlcm5hbWU=:dGVzdGVyMTQ=</user>
        </users>
        <forceduser>831</forceduser>
        <session>
            <type>0</type>
        </session>
        <authorization>
