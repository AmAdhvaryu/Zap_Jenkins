...
def contextInfo = sh "docker exec -d owasp zap.sh -verbosity INFO -p 2375 --api-key ${env.API_KEY} -dir /zap/amruta context info CmAuthtwo.context,returnStatus: true,
                        returnStdout: true "
			echo contextInfo
